<template>
  <div class="q-pa-md">
    ...
    <q-form @submit.prevent="submitChallenge">
      ...
      <q-toggle class="q-mt-md" label="isActive" v-model="challenge.isActive"></q-toggle>
      ...
      <q-select v-model="challenge.type" label="Challenge Type" class="q-mb-md" dense rounded outlined options-dense required

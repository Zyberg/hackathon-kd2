...
export const TemplateSuccess = (challengeTitle: string) => `<!doctype html>
...
<tr>
<td class="es-m-txt-c" align="center"><h1 style="color: #504678;font-family: verdana, geneva, sans-serif">Congratulations!</h1></td>
</tr>
<tr>
<td class="es-m-txt-c es-p15t" align="center"><p style="color: #504678;font-family: verdana, geneva, sans-serif;font-size: 16px">You've completed the "${challengeTitle}" challenge!</p></td>
</tr>
</table></td>
</tr>
</table></td>

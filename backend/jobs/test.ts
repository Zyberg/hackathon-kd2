...
const makeEmailInviteTemplate = (challengeTitle: string, challengeUri: string) => `<!doctype html>
...
<tr>
<td class="es-p20t" align="left">
<table width="100%" cellspacing="0" cellpadding="0">
<tr>
<td align="center" width="600" valign="top">
<table width="100%" cellspacing="0" cellpadding="0" role="presentation">
<tr>
<td class="es-p20r es-p20l" align="center" style="font-size: 0px"><img class="adapt-img" src="https://glffio.stripocdn.email/content/guids/CABINET_029383f22d008792ec6181d89f2755c5625126f201c1605f5e21684d4b4cbbd7/images/win.png" alt="Image" style="display: block" title="Image" width="165" height="165" layout="responsive"></img></td>
</tr>
</table></td>
</tr>
</table></td>
...
<table width="100%" cellspacing="0" cellpadding="0" style="border-width: 4px;border-style: solid;border-color: transparent" role="presentation">
<tr>
<td class="es-m-txt-c" align="center"><h1 style="color: #504678;font-family: verdana, geneva, sans-serif">Hello!</h1></td>
</tr>
<tr>
<td class="es-m-txt-c es-p15t" align="center"><p style="color: #504678;font-family: verdana, geneva, sans-serif;font-size: 16px">You've been challenged to "${challengeTitle}"<br>If you accept the invitation, press "Accept".</p></td>
</tr>
<tr>
<td class="es-p20t es-p15b es-p10r es-p10l" align="center">
<!--[if mso]><a href="http://localhost:9000/" target="_blank" hidden>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="http://localhost:9000/"
style="height:31px; v-text-anchor:middle; width:115px" arcsize="50%" stroke="f" fillcolor="#7b93ff">
<w:anchorlock></w:anchorlock>
<center style='color:#efefef; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:11px; font-weight:400; line-height:11px; mso-text-raise:1px'>ACCEPT</center>
</v:roundrect></a>
<![endif]-->
<!--[if !mso]><!-- --><span class="msohide es-button-border" style="background: #7b93ff;border-color: #7b93ff"><a href="http://localhost:9000/" class="es-button" target="_blank" style="background: #7b93ff;border-color: #7b93ff;font-family: arial, &quot;helvetica neue&quot;, helvetica, sans-serif">ACCEPT</a></span>
<!--<![endif]--></td>
</tr>
</table></td>
</tr>
...
<tr>
<td class="es-p20r es-p20l" align="center" style="font-size: 0px"><img class="adapt-img" src="
https://www.mobilepaygroup.com/mobilepaymedia/mobilepay-global/material-bank-global/preview-pictures-global/logo-preview/preview-mp-logo-and-type-horizontal-blue.png?filelibraryid=619AFEC37C994D92A7B574E2A20CB7B9&mediaid=22C1646C92FB4FE7B35211524E91BA35&mw=1000&hash=AEBB66DDA343A8E278F787D307582479BE09DF3C
" alt="Image" style="display: block" title="Image" width="333" height="138.3" layout="responsive"></img></td>
</td>
</tr>
<tr>
...
async function sendChallengeCompleteEmail() {
    const data = await EmailBuilder.makeChallengeInviteEmail("nikolajus.elkana@gmail.com", "nikolajus.elkana@gmail.com", "Challenge complete", makeEmailInviteTemplate('testinis challenge', 'http://localhost:9000/challenge'))

...
const usePasswordResetViaEmail: UsePasswordResetViaEmail = () => {
  ...
  function resetRequestForm () {
    Object.keys(requestForm.value).forEach(key => { (requestForm.value as any)[key] = '' })
  }
  ...
  function resetResetPasswordForm () {
    Object.keys(resetPasswordForm.value).forEach(key => { (resetPasswordForm.value as any)[key] = '' })
  }
